...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white py-16 border-t border-green-500/20">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-green-400 transition-colors">Cloud Backends</a></li>
              <li><a href="#" className="hover:text-green-400 transition-colors">Design & Branding</a></li>
            </ul>
          </div>
