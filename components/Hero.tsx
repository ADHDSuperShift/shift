      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 leading-tight">
            Super<span className="text-green-400 glow-green-strong">Shift</span> Labs
          </h1>
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          mobile apps, and cloud solutions that drive business transformation.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button 
            onClick={() => scrollToSection('services')}
            className="px-8 py-4 bg-green-500 hover:bg-green-600 text-black font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-glow-green"
          >
            Explore Services
          </button>
          <button 
